...
export default function FeaturesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main id="main-content" className="pt-20 pb-12" tabIndex={-1} role="main">
        ...
        >
          <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-white via-slate-50 to-blue-50/60 px-6 py-10 sm:px-10 sm:py-14 lg:px-14 shadow-sm">
            <div
              className="pointer-events-none absolute -top-24 -right-24 h-72 w-72 rounded-full bg-blue-200/25 blur-3xl"
              aria-hidden="true"
            />
            <div
              className="pointer-events-none absolute -bottom-24 -left-24 h-72 w-72 rounded-full bg-indigo-200/20 blur-3xl"
              aria-hidden="true"
            />
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div
                ...
                role="region"
                aria-labelledby="workflow-snapshot"
              >
                <p
                  className="text-xs font-semibold tracking-wide uppercase text-blue-700"
        ...
        >
          <h2 id="feature-grid-title" className="text-2xl sm:text-3xl font-bold tracking-tight text-slate-900">
            Full capability set for modern job search execution
          </h2>
          <p className="mt-3 max-w-3xl text-slate-600">
            Each feature is built to move you from application drafting to confident submission faster.
          </p>
        </section>
